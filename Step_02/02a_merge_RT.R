...
fwrite(RT_data_2a, paste0(path, "/Step_02/out_2a_RT_merged/RT_", year_start, "_", year_finish, "_", sample_name, ".csv"))
...
fwrite(RT_data_UK, paste0(path, "/Step_02/out_2a_RT_merged/RT_UK_", year_start, "_", year_finish, "_", sample_name, ".csv"))


RT_data_US<-RT_data %>% filter(country == "US") %>% select("trial_name",	"congruent_trial",	"M")
names(RT_data_UK)[1]<-"stimuli"
names(RT_data_UK)[2]<-"congruent"
fwrite(RT_data_US, paste0(path, "/Step_02/out_2a_RT_merged/RT_US_", year_start, "_", year_finish, "_", sample_name, ".csv"))
...
fwrite(RT_data_mean, paste0(path, "/Step_02/out_2a_RT_merged/RT_mean_", year_start, "_", year_finish, "_", sample_name, ".csv"))
}
